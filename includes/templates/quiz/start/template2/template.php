...
$html = '<div class="rbtq_template_wrapper rbtqs_template_wrapper">
			<div class="rbtq_template rbtq_start_template rbtq_start_template2  rbtq_start_template_withbutton rbt_template_wrapper_customizer_init rbt_template_enable_drag_drop_outer">
				<div class="rbtq-Template-title  rbt_template_drag_drop_item_section ui_helper_my_custom_element">
				'.$drag_section_action_btn_html.'<div class="rbt_tiny_mce_editor"><div>Enter the Quiz Title</div></div></div>		
				
				 <div class=" rbtq_content rbt_template_drag_drop_item_section ui_helper_my_custom_element ">'.$drag_section_action_btn_html.'<div class="rbt_tiny_mce_editor"><div> Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it.</div></div></div>  
				 	<div class="rbt_template_drag_drop_item_section rbt_template_text_center rbt_drag_btn_delete_hide ui_helper_my_custom_element">'.$drag_section_action_btn_html.'
