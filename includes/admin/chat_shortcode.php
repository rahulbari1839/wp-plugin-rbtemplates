...
$rbt_temp_chat_default_msg = "What can I help you today?";
$rbt_temp_chat_offline_msg = "Thanks for contact us. We will join you soon.";
	...
	<div class="tab-content p-4" id="rbTabContent">
	  <div class="tab-pane fade  <?php if(!$form_edit_mode){ echo ' show active ';} ?>" id="rbt_tab_1" role="tabpanel" aria-labelledby="rbt_tab_1_tab">
		<input type="hidden" class="form-control" id="rbt_form_edit_id" value="<?php echo $form_edit_id;?>">
		 ...
		 <div class="form-group">
			<label ><h5>Select Chat System Type</h5></label>
			<select class="input-group form-control rbt_div_width_200" id="rbt_temp_connect_chat_system" name="rbt_temp_connect_chat_system"  >
				<option value="chat_gtp">Chat-GTP </option>
				<!--option value="popup" <?php //if($display_type == 'popup'){ echo 'selected'; } ?>>Popup </option-->
				<!--option value="button_click" <?php //if($display_type == 'button_click'){ echo 'selected'; } ?>>Button-Click</option-->
			</select>  
		</div>	
	  ...
	  <div class="row">
		...
		<div class="customized-optional">
			<div class="customizer_heading">Message section style 
			<i class="fa fa-angle-up coptional-open-close-btn" aria-hidden="true"></i></div>
			<ul class="templates-styles customized-optional-ul" style="display: none">
			
				<li >
					<label>Send Msg Background Color </label>
					<div class="input-group ">
					  <div id="rbt_temp_send_msg_background_color_div" class="input-group colorpicker-component colorpicker-element">
					  <input type="text" value="<?php echo $rbt_temp_send_msg_background_color; ?>" id="rbt_temp_send_msg_background_color" name="rbt_temp_send_msg_background_color" class="form-control rbt_enable_color_customizer"> 
					  <span class="input-group-addon">
						  <i></i>
					   </span>
					  </div>
				...
				<li >
					<label>Received Msg Background Color </label>
					<div class="input-group ">
					  <div id="rbt_temp_received_msg_background_color_div" class="input-group colorpicker-component colorpicker-element">
					  <input type="text" value="<?php echo $rbt_temp_received_msg_background_color; ?>" id="rbt_temp_received_msg_background_color" name="rbt_temp_received_msg_background_color" class="form-control rbt_enable_color_customizer"> 
					  <span class="input-group-addon">
						  <i></i>
					   </span>
					  </div>
				...
				<li >
					...
					<div class="input-group ">
					<textarea name="rbt_temp_chat_default_msg" id="rbt_temp_chat_default_msg"  class="rbt_full_width rbt_enable_text_customizer"><?php echo $rbt_temp_chat_default_msg; ?></textarea>
					</div>
				</li>
				...
				<li >
					...
					<div class="input-group ">
					<textarea name="rbt_temp_chat_offline_msg" id="rbt_temp_chat_offline_msg" class="rbt_full_width rbt_enable_text_customizer"><?php echo $rbt_temp_chat_offline_msg; ?></textarea>
					</div>
				</li>
