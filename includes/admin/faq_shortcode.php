...
$temp_button_click_html = '<div class="rbt_temp_button_click_show_outer"><div class="rbt_temp_button_click_show   %%template_button_click_merge_class%% rbt_tiny_mce_editor">Click to Contact-us</div></div>';
		...
		<div class="customized-optional">
			...
			<li >
				...
				<li >
					...
					<div class="input-group ">
						<div class="input-group colorpicker-component">
						<input id="rbt_temp_submit_btn_radius" name="rbt_temp_submit_btn_radius" class="form-control rbt_enable_color_customizer" data-slider-id='ex1Slider' type="text" data-slider-min="0" data-slider-max="20" data-slider-step="1" data-slider-value="<?php echo $rbt_temp_submit_btn_radius; ?>" /> 
					</div>
				</div>
				</li>
			</ul>
