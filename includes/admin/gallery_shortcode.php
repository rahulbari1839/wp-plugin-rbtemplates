...
$temp_button_click_html = '<div class="rbt_temp_button_click_show_outer"><div class="rbt_temp_button_click_show   %%template_button_click_merge_class%% rbt_tiny_mce_editor">Click to View</div></div>';
...
<div class="rbt_main_container   template_type_outer_container_class_<?php echo $template_type; ?>">
	...
	<div class="tab-content p-4" id="rbTabContent">
	  <div class="tab-pane fade  <?php if(!$form_edit_mode){ echo ' show active ';} ?>" id="rbt_tab_1" role="tabpanel" aria-labelledby="rbt_tab_1_tab">
		<input type="hidden" class="form-control" id="rbt_form_edit_id" value="<?php echo $form_edit_id;?>">
		 ...
		 <div class="form-group form-group col-sm-4 ml-0 pl-0">
			<label for="rbt_form_name"><?php echo ucfirst($template_type); ?>  Page Name</label>
			...
			<label ><h5>Select Template</h5></label>
			  ...
			  <ul class="rbt_templates_list  rbt_field_required" data-error-type="lenght" data-error-class="rbt_selcted_temp" data-error-class data-error-msg="Please select a template" >
				...
				<div>
					...
					<img class="img_prev" src="<?php echo plugin_dir_url(__FILE__)."../templates/".$template_type."/template1/preview.jpg?".$rand_no; ?>">
					<div class="rbt_overlay_inner"></div>
					<div class="rbt_select_btn">
					<span class="btn btn-primary" onclick="rbt_template_privew('<?php echo plugin_dir_url(__FILE__)."../templates/".$template_type."/template1/preview.jpg?".$rand_no; ?>')">Preview</span>
	  ...
	  <div class="row">
		<div class="col-sm-3">
			<a  class="btn rbt_transprent_btn " onclick="rbt_preview_shortcode(this)" href="javascript:void(0)" style=" float: right;">Preview Shortcode</a>
			<?php 
				include_once('drag_drop_elements.php'); 
				//include_once('select_custom_fields_list.php'); 
		...
		<div class="customized-optional" style="display: none;">
		...
		<div class="customized-optional">
			<div class="customizer_heading">External Shadow <i class="fa fa-angle-up coptional-open-close-btn" aria-hidden="true"></i></div>
			<ul class="templates-styles customized-optional-ul" style="display: none">
				<li>
